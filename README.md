...
- **Outline & heading tools**: [Restructure Outline by Headings](https://hugomarins.github.io/incremental-remnote/Utilities/#restructure-outline-by-headings) (re-nest a flat or mis-pasted document under its headings), [Apply Heading Levels by Hierarchy (Table of Contents)](https://hugomarins.github.io/incremental-remnote/Utilities/#apply-heading-levels-by-hierarchy-table-of-contents), and [Set Next Heading Level](https://hugomarins.github.io/incremental-remnote/Utilities/#set-next-heading-level) — all with side-by-side previews and one-click undo.
- **Queue display control**: [Hide / Remove Parent & Grandparent and more](https://hugomarins.github.io/incremental-remnote/Utilities/#queue-display-utilities) to clean up how ancestor Rems appear on your flashcards.
- **Editing helpers**: [Text Case Converter](https://hugomarins.github.io/incremental-remnote/Utilities/#text-case-converter) (Shift+F3 cycling, with English/Portuguese title-case rules) and [Bulletize Inline Selected Text](https://hugomarins.github.io/incremental-remnote/Utilities/#bulletize-inline-selected-text) for restoring bullets that PDF highlights flatten.
- **Navigation & sources**: [Find Rem](https://hugomarins.github.io/incremental-remnote/Utilities/#find-rem--reference-or-open) (surfaces Rems RemNote's `[[` search can't) and [Open Source in Popup / Floating Window](https://hugomarins.github.io/incremental-remnote/Utilities/#open-source-in-popup) to peek at a PDF/web source without leaving the queue.
